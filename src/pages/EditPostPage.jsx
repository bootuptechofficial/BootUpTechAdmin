...
import { fetchPostStatus, updatePost, uploadImage } from '../utils/api';
...
export default function EditPostPage() {
  ...
  if (initialLoading) {
    return <div className="flex justify-center py-20"><div className="w-8 h-8 border-4 text-primary-500 border-current border-t-transparent rounded-full animate-spin"></div></div>;
  }
          ...
          <div className="admin-card p-5">
            ...
            {post.featuredImage ? (
              ...
              <label className="flex flex-col items-center justify-center w-full aspect-video border-2 border-dashed border-dark-700 rounded-xl cursor-pointer bg-dark-800/50 hover:bg-dark-800 hover:border-primary-500/50 transition-colors group">
                ...
                <span className="text-sm text-dark-400 font-medium">Upload Image</span>
